...
-- cmdline completion
-- https://github.com/neovim/neovim/pull/32709#issuecomment-2695155235
...
vim.api.nvim_create_autocmd('CmdlineChanged', {
  ...
  callback = function()
    ...
    if curpos == #cmdline + 1 and vim.fn.pumvisible() == 0 and last_char:match('[%w%/%: ]') and not cmdline:match('^%d+$') then
